...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <li><a href="<?php echo base_url(). 'product_controller/insert'; ?>">Insert</a></li>
   ...
   <form action="<?php echo base_url(). 'product_controller/editProduct/' . $product->id;    ?>" method="post" enctype='multipart/form-data'>
    		<h3>Sửa Thông Tin Sản Phâm</h3>
      		<table>
          		<tr>
          			<th>Tên</th>
                ...
                <td><img src="<?php echo base_url() . 'upload/' . $product->image; ?>"></td>
          		</tr>
          		<tr>
